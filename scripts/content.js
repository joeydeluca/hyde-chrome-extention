...
const getValidImages = function() {
    let images = Array.from(document.getElementsByTagName('img'))
        ...
        .filter(img => !img.currentSrc.includes('.gif') && !img.currentSrc.includes('/gif') && !img.currentSrc.includes('gradient') && !img.currentSrc.includes('.svg') && !img.currentSrc.includes('/svg'))
